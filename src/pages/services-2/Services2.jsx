...
const Services2 = () => {
  ...
  const services = [
    {
      ...
      gradient: "linear-gradient(180deg, rgba(0, 0, 0, 0.6) 50%, rgba(0, 0, 0, 0.1) 100%)"
    },
    {
      title: "Mobile Applications",
      description: "Creating seamless native and cross-platform mobile experiences",
      image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1920&h=1080&fit=crop",
      gradient: "linear-gradient(180deg, rgba(0, 0, 0, 0.6) 50%, rgba(0, 0, 0, 0.1) 100%)"
    },
    {
      title: "UI/UX Design",
      description: "Crafting intuitive and beautiful user interfaces that delight your customers",
      image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=1920&h=1080&fit=crop",
      gradient: "linear-gradient(180deg, rgba(0, 0, 0, 0.6) 50%, rgba(0, 0, 0, 0.1) 100%)"
    },
    {
      title: "Digital Marketing",
      description: "Driving growth through strategic campaigns and data-driven insights",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1920&h=1080&fit=crop",
      gradient: "linear-gradient(180deg, rgba(0, 0, 0, 0.6) 50%, rgba(0, 0, 0, 0.1) 100%)"
    },
    {
      title: "Cloud Solutions",
      description: "Scalable infrastructure and cloud-native architectures for the future",
  ...
  useEffect(() => {
    ...
    splitDescriptionsRef.current = descriptionsRef.current.map(desc => 
      new SplitText(desc, { type: "chars,words,lines", linesClass: "clip-text" })
    );
