...
const Influencers = () => {
  ...
  useEffect(() => {
    ...
    loadInfluencers(activeSectionId, { lang: language, per_page: 4 });
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Influencers Grid - Simple Layout */}
        <div className="flex flex-wrap justify-center gap-12 min-h-[370px]">
            ...
            influencers.map((inf, idx) => {
              return (
                <div
                  ...
                  className="flex flex-col items-center text-center w-full sm:w-[calc(50%-24px)] lg:w-[calc(25%-36px)] max-w-[280px]"
                >
                  {/* Influencer Image */}
                  <div className="relative w-48 h-48 mb-4 rounded-full overflow-hidden bg-gradient-to-br from-[#52C3C5]/20 to-[#5269C5]/20 shadow-xl transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-[#52C3C5]/30">
                    <img
                      src={inf.image}
                      alt={inf.name}
                  ...
                  {/* Name */}
                  <h3 className="text-xl font-bold mb-2 text-[var(--foreground)] transition-colors duration-300 hover:text-[#52C3C5]">
                    {inf.name}
                  </h3>

                  {/* Primary Subtitle */}
                  {inf.primarySubtitle && (
                    <p className="text-sm text-[#52C3C5] font-medium mb-1">
                      {inf.primarySubtitle}
                    </p>
                  )}
                    ...
                    {inf.socialLinks?.map((social, socialIdx) => {
                      ...
                      return (
                        <a
                          ...
                          className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-[#52C3C5] to-[#5269C5] text-white transition-all duration-500 hover:scale-125 hover:-rotate-12 shadow-lg hover:shadow-2xl hover:shadow-[#52C3C5]/50"
